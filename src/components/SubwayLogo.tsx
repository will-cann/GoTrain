...
export function SubwayLogo({ size = 28 }: { size?: number }) {
    return (
        <span className="inline-flex items-center gap-1">
            <SubwayCircle letter="G" color="#00bf63" size={size} />
            <SubwayCircle letter="O" color="#ff751f" size={size} />
        </span>
    );
}
    ...
    return (
        <div className="inline-flex flex-col items-start gap-3">
            <div className="inline-flex items-center gap-2">
                <SubwayCircle letter="G" color="#00bf63" size={56} />
                <SubwayCircle letter="O" color="#ff751f" size={56} />
